...
def load_nodes():
    # OPTIMIZATION: Scan py/ directory for Python files
    for file in nodes_dir.rglob("*.py"):
        ...
        try:
            ...
            if spec and spec.loader:
                ...
                # CRITICAL FIX: Explicitly register the module in sys.modules
                # This prevents cascading import errors when modules or ComfyUI components reference each other.
            ...
            # ERROR HANDLING
            print(f"[NovA Custom Nodes] Error loading module {file.name}: {e}")

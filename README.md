...
- The "NovAUltimateT2I" all-in-one node is designed to replace all other nodes used in a standard text-to-image workflow. It is still under development, but you can try it out nonetheless; notably, this node requires only a single "spaghetti" connection to link it to an image preview.
